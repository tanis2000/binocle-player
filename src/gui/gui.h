...
void gui_render_to_screen(struct gui_t *gui, struct binocle_gd *gd, struct binocle_window *window, float design_width, float design_height, kmAABB2 viewport, kmMat4 matrix, float scale, bool pixel_perfect);
